...
src = "https://github.com/SpinalHDL/SpinalHDL.git"
...
try:
    ...
    pass
data_git_hash = "8091de30187f924cf1ec122a4127175cb57bf16f"
...
def data_file(f):
    """Get absolute path for file inside pythondata_misc_usb_ohci."""
    fn = os.path.join(data_location, f)
    fn = os.path.abspath(fn)
    if not os.path.exists(fn):
        raise IOError("File {f} doesn't exist in pythondata_misc_usb_ohci".format(f))
    return fn
