// Generator : SpinalHDL v1.4.4    git head : 8091de30187f924cf1ec122a4127175cb57bf16f
// Component : UsbOhciWishbone_Dw32_Pc1_Pf48000000
// Git hash  : 8091de30187f924cf1ec122a4127175cb57bf16f
...
`define endpoint_enumDefinition_binary_sequential_endpoint_TD_READ_DELAY 5'b00110
`define endpoint_enumDefinition_binary_sequential_endpoint_TD_ANALYSE 5'b00111
`define endpoint_enumDefinition_binary_sequential_endpoint_TD_CHECK_TIME 5'b01000
`define endpoint_enumDefinition_binary_sequential_endpoint_BUFFER_READ 5'b01001
`define endpoint_enumDefinition_binary_sequential_endpoint_TOKEN 5'b01010
`define endpoint_enumDefinition_binary_sequential_endpoint_DATA_TX 5'b01011
`define endpoint_enumDefinition_binary_sequential_endpoint_DATA_RX 5'b01100
`define endpoint_enumDefinition_binary_sequential_endpoint_DATA_RX_VALIDATE 5'b01101
`define endpoint_enumDefinition_binary_sequential_endpoint_ACK_RX 5'b01110
`define endpoint_enumDefinition_binary_sequential_endpoint_ACK_TX_0 5'b01111
`define endpoint_enumDefinition_binary_sequential_endpoint_ACK_TX_1 5'b10000
`define endpoint_enumDefinition_binary_sequential_endpoint_ACK_TX_EOP 5'b10001
`define endpoint_enumDefinition_binary_sequential_endpoint_DATA_RX_WAIT_DMA 5'b10010
`define endpoint_enumDefinition_binary_sequential_endpoint_UPDATE_TD_PROCESS 5'b10011
`define endpoint_enumDefinition_binary_sequential_endpoint_UPDATE_TD_CMD 5'b10100
`define endpoint_enumDefinition_binary_sequential_endpoint_UPDATE_ED_CMD 5'b10101
`define endpoint_enumDefinition_binary_sequential_endpoint_UPDATE_SYNC 5'b10110
`define endpoint_enumDefinition_binary_sequential_endpoint_ABORD 5'b10111
...
module UsbOhciWishbone_Dw32_Pc1_Pf48000000 (
  output              io_dma_CYC,
  output              io_dma_STB,
  input               io_dma_ACK,
  output              io_dma_WE,
  ...
  UsbOhciWishbone_Dw32_Pc1_Pf48000000_BmbToWishbone front_dmaBridge (
  ...
  UsbOhciWishbone_Dw32_Pc1_Pf48000000_WishboneToBmb front_ctrlBridge (
  ...
  UsbOhciWishbone_Dw32_Pc1_Pf48000000_UsbOhci front_ohci (
  ...
  UsbOhciWishbone_Dw32_Pc1_Pf48000000_UsbLsFsPhy back_phy (
  ...
  UsbOhciWishbone_Dw32_Pc1_Pf48000000_CtrlCc cc (
...
module UsbOhciWishbone_Dw32_Pc1_Pf48000000_CtrlCc (
  ...
  UsbOhciWishbone_Dw32_Pc1_Pf48000000_BufferCC_16 input_lowSpeed_buffercc (
    .io_dataIn     (input_lowSpeed                      ), //i
    .io_dataOut    (input_lowSpeed_buffercc_io_dataOut  ), //o
    .phy_clk       (phy_clk                             ), //i
    .phy_reset     (phy_reset                           )  //i
  );
  UsbOhciWishbone_Dw32_Pc1_Pf48000000_BufferCC_16 input_usbReset_buffercc (
    .io_dataIn     (input_usbReset                      ), //i
    .io_dataOut    (input_usbReset_buffercc_io_dataOut  ), //o
    .phy_clk       (phy_clk                             ), //i
    .phy_reset     (phy_reset                           )  //i
  );
  UsbOhciWishbone_Dw32_Pc1_Pf48000000_BufferCC_16 input_usbResume_buffercc (
    .io_dataIn     (input_usbResume                      ), //i
    .io_dataOut    (input_usbResume_buffercc_io_dataOut  ), //o
    .phy_clk       (phy_clk                              ), //i
    .phy_reset     (phy_reset                            )  //i
  );
  UsbOhciWishbone_Dw32_Pc1_Pf48000000_BufferCC_19 output_overcurrent_buffercc (
    .io_dataIn     (output_overcurrent                      ), //i
    .io_dataOut    (output_overcurrent_buffercc_io_dataOut  ), //o
    .ctrl_clk      (ctrl_clk                                ), //i
    .ctrl_reset    (ctrl_reset                              )  //i
  );
  UsbOhciWishbone_Dw32_Pc1_Pf48000000_StreamCCByToggle input_tx_ccToggle (
  ...
  UsbOhciWishbone_Dw32_Pc1_Pf48000000_PulseCCByToggle pulseCCByToggle (
  ...
  UsbOhciWishbone_Dw32_Pc1_Pf48000000_FlowCCByToggle output_rx_flow_ccToggle (
  ...
  UsbOhciWishbone_Dw32_Pc1_Pf48000000_BufferCC_19 output_rx_active_buffercc (
    .io_dataIn     (output_rx_active                      ), //i
    .io_dataOut    (output_rx_active_buffercc_io_dataOut  ), //o
    .ctrl_clk      (ctrl_clk                              ), //i
    .ctrl_reset    (ctrl_reset                            )  //i
  );
  UsbOhciWishbone_Dw32_Pc1_Pf48000000_PulseCCByToggle pulseCCByToggle_1 (
  ...
  UsbOhciWishbone_Dw32_Pc1_Pf48000000_BufferCC_16 input_ports_0_removable_buffercc (
    .io_dataIn     (input_ports_0_removable                      ), //i
    .io_dataOut    (input_ports_0_removable_buffercc_io_dataOut  ), //o
    .phy_clk       (phy_clk                                      ), //i
    .phy_reset     (phy_reset                                    )  //i
  );
  UsbOhciWishbone_Dw32_Pc1_Pf48000000_BufferCC_16 input_ports_0_power_buffercc (
    .io_dataIn     (input_ports_0_power                      ), //i
    .io_dataOut    (input_ports_0_power_buffercc_io_dataOut  ), //o
    .phy_clk       (phy_clk                                  ), //i
    .phy_reset     (phy_reset                                )  //i
  );
  UsbOhciWishbone_Dw32_Pc1_Pf48000000_BufferCC_19 output_ports_0_lowSpeed_buffercc (
    .io_dataIn     (output_ports_0_lowSpeed                      ), //i
    .io_dataOut    (output_ports_0_lowSpeed_buffercc_io_dataOut  ), //o
    .ctrl_clk      (ctrl_clk                                     ), //i
    .ctrl_reset    (ctrl_reset                                   )  //i
  );
  UsbOhciWishbone_Dw32_Pc1_Pf48000000_BufferCC_19 output_ports_0_overcurrent_buffercc (
    .io_dataIn     (output_ports_0_overcurrent                      ), //i
    .io_dataOut    (output_ports_0_overcurrent_buffercc_io_dataOut  ), //o
    .ctrl_clk      (ctrl_clk                                        ), //i
    .ctrl_reset    (ctrl_reset                                      )  //i
  );
  UsbOhciWishbone_Dw32_Pc1_Pf48000000_PulseCCByToggle pulseCCByToggle_2 (
  ...
  UsbOhciWishbone_Dw32_Pc1_Pf48000000_PulseCCByToggle pulseCCByToggle_3 (
  ...
  UsbOhciWishbone_Dw32_Pc1_Pf48000000_PulseCCByToggle pulseCCByToggle_4 (
  ...
  UsbOhciWishbone_Dw32_Pc1_Pf48000000_StreamCCByToggleWithoutBuffer input_ports_0_reset_ccToggle (
  ...
  UsbOhciWishbone_Dw32_Pc1_Pf48000000_StreamCCByToggleWithoutBuffer input_ports_0_suspend_ccToggle (
  ...
  UsbOhciWishbone_Dw32_Pc1_Pf48000000_StreamCCByToggleWithoutBuffer input_ports_0_resume_ccToggle (
  ...
  UsbOhciWishbone_Dw32_Pc1_Pf48000000_StreamCCByToggleWithoutBuffer input_ports_0_disable_ccToggle (
...
module UsbOhciWishbone_Dw32_Pc1_Pf48000000_UsbLsFsPhy (
  ...
  UsbOhciWishbone_Dw32_Pc1_Pf48000000_UsbLsFsPhyFilter ports_0_filter (
...
module UsbOhciWishbone_Dw32_Pc1_Pf48000000_UsbOhci (
  ...
  UsbOhciWishbone_Dw32_Pc1_Pf48000000_StreamFifo fifo (
  ...
  UsbOhciWishbone_Dw32_Pc1_Pf48000000_Crc token_crc5 (
    .io_flush            (_zz_70                         ), //i
  ...
  UsbOhciWishbone_Dw32_Pc1_Pf48000000_Crc_1 dataTx_crc16 (
    .io_flush            (_zz_72                             ), //i
  ...
  UsbOhciWishbone_Dw32_Pc1_Pf48000000_Crc_2 dataRx_crc16 (
    .io_flush            (_zz_74                            ), //i
  ...
  always @(*) begin
    case(endpoint_stateReg)
      ...
      `endpoint_enumDefinition_binary_sequential_endpoint_TD_READ_DELAY : endpoint_stateReg_string = "endpoint_TD_READ_DELAY    ";
  ...
  always @(*) begin
    case(endpoint_stateNext)
      ...
      `endpoint_enumDefinition_binary_sequential_endpoint_TD_READ_DELAY : endpoint_stateNext_string = "endpoint_TD_READ_DELAY    ";
  ...
  always @ (*) begin
    ...
    case(endpoint_stateReg)
      ...
      `endpoint_enumDefinition_binary_sequential_endpoint_TD_READ_DELAY : begin
      end
  ...
  always @ (*) begin
    ...
    case(endpoint_stateReg)
      ...
      `endpoint_enumDefinition_binary_sequential_endpoint_UPDATE_SYNC : begin
        if(dmaCtx_pendingEmpty)begin
          if((! (endpoint_ED_F && endpoint_TD_isoOverrunReg)))begin
            endpoint_applyNextED = 1'b1;
          end
        end
      end
    ...
    case(endpoint_stateReg)
      ...
      `endpoint_enumDefinition_binary_sequential_endpoint_TD_READ_RSP : begin
        if(((ioDma_rsp_valid && ioDma_rsp_ready) && ioDma_rsp_payload_last))begin
          endpoint_stateNext = `endpoint_enumDefinition_binary_sequential_endpoint_TD_READ_DELAY;
        end
      end
      `endpoint_enumDefinition_binary_sequential_endpoint_TD_READ_DELAY : begin
  ...
  always @ (posedge ctrl_clk) begin
    ...
    endpoint_TD_lastOffset <= (endpoint_ED_F ? _zz_178 : {(! endpoint_TD_isSinglePage),endpoint_TD_BE[11 : 0]});
...
module UsbOhciWishbone_Dw32_Pc1_Pf48000000_WishboneToBmb (
  input               io_input_CYC,
  input               io_input_STB,
  output              io_input_ACK,
  input               io_input_WE,
...
module UsbOhciWishbone_Dw32_Pc1_Pf48000000_BmbToWishbone (
...
//UsbOhciWishbone_Dw32_Pc1_Pf48000000_StreamCCByToggleWithoutBuffer replaced by UsbOhciWishbone_Dw32_Pc1_Pf48000000_StreamCCByToggleWithoutBuffer

//UsbOhciWishbone_Dw32_Pc1_Pf48000000_StreamCCByToggleWithoutBuffer replaced by UsbOhciWishbone_Dw32_Pc1_Pf48000000_StreamCCByToggleWithoutBuffer

//UsbOhciWishbone_Dw32_Pc1_Pf48000000_StreamCCByToggleWithoutBuffer replaced by UsbOhciWishbone_Dw32_Pc1_Pf48000000_StreamCCByToggleWithoutBuffer

module UsbOhciWishbone_Dw32_Pc1_Pf48000000_StreamCCByToggleWithoutBuffer (
  ...
  UsbOhciWishbone_Dw32_Pc1_Pf48000000_BufferCC outHitSignal_buffercc (
    .io_dataIn     (outHitSignal                      ), //i
    .io_dataOut    (outHitSignal_buffercc_io_dataOut  ), //o
    .ctrl_clk      (ctrl_clk                          ), //i
    .ctrl_reset    (ctrl_reset                        )  //i
  );
  UsbOhciWishbone_Dw32_Pc1_Pf48000000_BufferCC_9 pushArea_target_buffercc (
...
//UsbOhciWishbone_Dw32_Pc1_Pf48000000_PulseCCByToggle replaced by UsbOhciWishbone_Dw32_Pc1_Pf48000000_PulseCCByToggle

//UsbOhciWishbone_Dw32_Pc1_Pf48000000_PulseCCByToggle replaced by UsbOhciWishbone_Dw32_Pc1_Pf48000000_PulseCCByToggle

//UsbOhciWishbone_Dw32_Pc1_Pf48000000_PulseCCByToggle replaced by UsbOhciWishbone_Dw32_Pc1_Pf48000000_PulseCCByToggle

//UsbOhciWishbone_Dw32_Pc1_Pf48000000_BufferCC_19 replaced by UsbOhciWishbone_Dw32_Pc1_Pf48000000_BufferCC_19

//UsbOhciWishbone_Dw32_Pc1_Pf48000000_BufferCC_19 replaced by UsbOhciWishbone_Dw32_Pc1_Pf48000000_BufferCC_19

//UsbOhciWishbone_Dw32_Pc1_Pf48000000_BufferCC_16 replaced by UsbOhciWishbone_Dw32_Pc1_Pf48000000_BufferCC_16
...
module UsbOhciWishbone_Dw32_Pc1_Pf48000000_FlowCCByToggle (
  input               io_input_valid,
  ...
  UsbOhciWishbone_Dw32_Pc1_Pf48000000_BufferCC inputArea_target_buffercc (
...
module UsbOhciWishbone_Dw32_Pc1_Pf48000000_PulseCCByToggle (
  input               io_pulseIn,
  output              io_pulseOut,
  input               phy_clk,
  input               phy_reset,
  ...
  UsbOhciWishbone_Dw32_Pc1_Pf48000000_BufferCC inArea_target_buffercc (
...
module UsbOhciWishbone_Dw32_Pc1_Pf48000000_StreamCCByToggle (
  input               io_input_valid,
  output reg          io_input_ready,
  ...
  UsbOhciWishbone_Dw32_Pc1_Pf48000000_BufferCC_1 pushArea_target_buffercc (
    .io_dataIn     (pushArea_target                      ), //i
    .io_dataOut    (pushArea_target_buffercc_io_dataOut  ), //o
    .phy_clk       (phy_clk                              ), //i
    .phy_reset     (phy_reset                            )  //i
...
module UsbOhciWishbone_Dw32_Pc1_Pf48000000_BufferCC_19 (
  input               io_dataIn,
  output              io_dataOut,
  input               ctrl_clk,
  input               ctrl_reset
...
module UsbOhciWishbone_Dw32_Pc1_Pf48000000_BufferCC_16 (
  input               io_dataIn,
  output              io_dataOut,
  input               phy_clk,
  input               phy_reset
...
module UsbOhciWishbone_Dw32_Pc1_Pf48000000_UsbLsFsPhyFilter (
  input               io_lowSpeed,
  input               io_usb_dp,
  input               io_usb_dm,
...
module UsbOhciWishbone_Dw32_Pc1_Pf48000000_Crc_2 (
  input               io_flush,
  input               io_input_valid,
...
module UsbOhciWishbone_Dw32_Pc1_Pf48000000_Crc_1 (
  input               io_flush,
  input               io_input_valid,
  input      [7:0]    io_input_payload,
  output     [15:0]   io_result,
...
module UsbOhciWishbone_Dw32_Pc1_Pf48000000_Crc (
  input               io_flush,
  input               io_input_valid,
...
module UsbOhciWishbone_Dw32_Pc1_Pf48000000_StreamFifo (
  input               io_push_valid,
...
//UsbOhciWishbone_Dw32_Pc1_Pf48000000_BufferCC_9 replaced by UsbOhciWishbone_Dw32_Pc1_Pf48000000_BufferCC_9

//UsbOhciWishbone_Dw32_Pc1_Pf48000000_BufferCC replaced by UsbOhciWishbone_Dw32_Pc1_Pf48000000_BufferCC
...
module UsbOhciWishbone_Dw32_Pc1_Pf48000000_BufferCC_9 (
  input               io_dataIn,
  output              io_dataOut,
  input               phy_clk,
  input               phy_reset
...
module UsbOhciWishbone_Dw32_Pc1_Pf48000000_BufferCC_1 (
  input               io_dataIn,
  output              io_dataOut,
  input               phy_clk,
  input               phy_reset
...
module UsbOhciWishbone_Dw32_Pc1_Pf48000000_BufferCC (
  input               io_dataIn,
  output              io_dataOut,
  input               ctrl_clk,
  input               ctrl_reset
